...
The application is deployed using a Helm chart (see `chart/ <https://gitlab.cta-observatory.org/cta-computing/suss/scienceportal/prototypes/ctao-data-explorer/-/blob/master/chart/README.md>`_).
